...
class APIKeyCreate(BaseModel):
    ...
    proxied_links: bool = Field(False, description="If True, links will be proxied through the server")
...
class APIKeyUpdate(BaseModel):
    ...
    proxied_links: Optional[bool] = Field(None, description="If True, links will be proxied through the server")
